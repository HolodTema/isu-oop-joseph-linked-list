...
# graph of real time
plt.plot(sizes, microsecondsReal, 'o-', label='реалььная сложность', color='blue', linewidth=3)

plt.plot(sizes, microsTheoryMNK, 'o-', label=f'теоретическая временная сложность = k*n^2 где k = {k}', color='red')
